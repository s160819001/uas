...
<div class="row">
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        <h3 class="float-start">Laporan Obat Terlaris</h3>
          ...
          <table class="table align-items-center px-3">
            <thead>
              <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Jumlah Dibeli</th>
            ...
            <tbody>
                    ...
                    <tr>
                      <td class="align-middle text-center">
                        <p class="text-xs font-weight-bold mb-0">{{$d->medicine_id}}</p>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p  class="text-lg text-secondary mb-0 ">{{$d->form}}</p>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center">
                        <p  class="text-xs font-weight-bold mb-0 ">{{$d->totaleachmedicine}}</p>
                      </td>
                      <td class="align-middle text-sm-end text-sm">
                        <p class="text-lr font-weight-bold mb-0">Rp {{number_format($d->price,0,',','.')}},-</p>
                      </td>
                    </tr>
                    @endforeach
            </tbody>
  ...
  @section('javascript')
      <script>
        ...
        document.getElementById("nav_best_selling_report").classList.add("active");
